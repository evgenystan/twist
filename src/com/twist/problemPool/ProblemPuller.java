...
public class ProblemPuller
{
	...
	{
		String reply=null,temp=null,test=null;
		...
		switch(id)
		{
			case 001 : 
				...
				temp=kTalker.executeCommand("evalString =   \"ClearAll[a,x,func,degree,center];a=\" <> ToString[a] <> \";func=\" <>    ToString[InputForm[func]] <> \";degree=\" <> ToString[degree] <>    \";center=\" <> ToString[center] <> \";\"");
			...
			case 002:
				...
				temp=kTalker.executeCommand("evalString = \"ClearAll[A,u,v,rank];A=\" <> ToString[InputForm[A]] <> \";u=\" <> ToString[InputForm[u]] <> \";v=\" <> ToString[InputForm[v]] <> \";rank=\" <> ToString[InputForm[rank]] <> \";\"");
				
				reply = "<div promptId = '2'><h2>Solving Linear Systems</h2></div><div><p>Let <script type=\"math/tex\">A</script> be a 3&times;3 matrix</p><p><div style='margin-left:auto;margin-right:auto'><script type=\"math/tex\">" + kTalker.executeCommand("TeXForm[MatrixForm[A]]") + "</script></div></p></div>";

				reply = reply + "<div promptId = '3'><h2>Question 1</h2><p>Compute the rank of the matrix <script type=\"math/tex\">A</script></p><div promptId = '3' class='inputbox'><script type=\"math/tex\">\\mathrm{rank}(A)=</script>&nbsp;<span class=\"inputfield\" style=\"font-size: 100%; font-family: STIXGeneral-Regular; \" contenteditable=\"true\" fieldId = \"1\"></span>&nbsp;<input promptId = '3' class=\"evalButton\" type=\"button\" value=\"Submit\" />&nbsp;<span id='resultsField3'></span></div></div>";
...
//				
		...
		ProblemDataPusher.problemDataStorage.put(id,temp);
		return reply;
	}
